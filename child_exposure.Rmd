...
selected_diagnoses <- reactive({
  table_selected_exposure_diagnoses( dpop(), exposure_diagnoses())
})
DT::dataTableOutput("tbl_selected_diagnoses")
output$tbl_selected_diagnoses <- DT::renderDataTable( selected_diagnoses() , 
                                                      options = list(
                                                        # order = list(6, 'desc'),
                                                        rownames = F
                                                      ))
